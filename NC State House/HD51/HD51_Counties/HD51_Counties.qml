...
<qgis styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" version="3.10.1-A Coruña" maxScale="0" simplifyAlgorithm="0" labelsEnabled="0" simplifyLocal="1" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" minScale="1e+08">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 type="graduatedSymbol" graduatedMethod="GraduatedColor" forceraster="0" symbollevels="0" attr="MARGIN" enableorderby="0">
    <ranges>
      <range lower="-9.999900000000000" upper="-0.500000000000000" symbol="0" label="R >50%" render="true"/>
      <range lower="-0.500000000000000" upper="-0.400000000000000" symbol="1" label="R 40-50%" render="true"/>
      <range lower="-0.400000000000000" upper="-0.300000000000000" symbol="2" label="R 30-40%" render="true"/>
      <range lower="-0.300000000000000" upper="-0.200000000000000" symbol="3" label="R 20-30%" render="true"/>
      <range lower="-0.200000000000000" upper="-0.150000000000000" symbol="4" label="R 15-20%" render="true"/>
      <range lower="-0.150000000000000" upper="-0.100000000000000" symbol="5" label="R 10-15%" render="true"/>
      <range lower="-0.100000000000000" upper="-0.050000000000000" symbol="6" label="R 5-10%" render="true"/>
      <range lower="-0.050000000000000" upper="-0.000100000000000" symbol="7" label="R 0-5%" render="true"/>
      <range lower="-0.000100000000000" upper="0.000100000000000" symbol="8" label="Tie" render="true"/>
      <range lower="0.000100000000000" upper="0.050000000000000" symbol="9" label="D 0-5%" render="true"/>
      <range lower="0.050000000000000" upper="0.100000000000000" symbol="10" label="D 5-10%" render="true"/>
      <range lower="0.100000000000000" upper="0.150000000000000" symbol="11" label="D 10-15%" render="true"/>
      <range lower="0.150000000000000" upper="0.200000000000000" symbol="12" label="D 15-20%" render="true"/>
      <range lower="0.200000000000000" upper="0.300000000000000" symbol="13" label="D 20-30%" render="true"/>
      <range lower="0.300000000000000" upper="0.400000000000000" symbol="14" label="D 30-40%" render="true"/>
      <range lower="0.400000000000000" upper="0.500000000000000" symbol="15" label="D 40-50%" render="true"/>
      <range lower="0.500000000000000" upper="9.999900000000000" symbol="16" label="D >50%" render="true"/>
      <range lower="9.999900000000000" upper="10.000000000000000" symbol="17" label="No Data" render="true"/>
    </ranges>
    <symbols>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory diagramOrientation="Up" enabled="0" rotationOffset="270" penAlpha="255" penColor="#000000" sizeType="MM" lineSizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" scaleBasedVisibility="0" backgroundColor="#ffffff" opacity="1" lineSizeType="MM" sizeScale="3x:0,0,0,0,0,0" barWidth="5" backgroundAlpha="255" height="15" width="15" penWidth="0" labelPlacementMethod="XHeight" minimumSize="0" minScaleDenominator="0" scaleDependency="Area">
      <fontProperties description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" style=""/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings linePlacementFlags="18" placement="1" obstacle="0" priority="0" showAll="1" zIndex="0" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    <alias name="" index="0" field="DISTRICT"/>
    <alias name="" index="1" field="FID"/>
    <alias name="" index="2" field="OBJECTID"/>
    <alias name="" index="3" field="PERIMETER"/>
    <alias name="" index="4" field="CO_NAME"/>
    <alias name="" index="5" field="CO_ABBR"/>
    <alias name="" index="6" field="ACRES"/>
    <alias name="" index="7" field="Shape_Leng"/>
    <alias name="" index="8" field="Shape_Area"/>
    <alias name="" index="9" field="RO"/>
  ...
  <defaults>
    ...
    <default field="CO_NAME" expression="" applyOnUpdate="0"/>
    <default field="CO_ABBR" expression="" applyOnUpdate="0"/>
    <default field="ACRES" expression="" applyOnUpdate="0"/>
    <default field="Shape_Leng" expression="" applyOnUpdate="0"/>
    <default field="Shape_Area" expression="" applyOnUpdate="0"/>
    <default field="RO" expression="" applyOnUpdate="0"/>
    <default field="layer" expression="" applyOnUpdate="0"/>
    <default field="path" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint exp_strength="0" unique_strength="0" field="DISTRICT" constraints="0" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" unique_strength="0" field="PERIMETER" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="CO_NAME" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="CO_ABBR" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="ACRES" constraints="0" notnull_strength="0"/>
    ...
    <constraint exp_strength="0" unique_strength="0" field="RO" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="layer" constraints="0" notnull_strength="0"/>
    <constraint exp_strength="0" unique_strength="0" field="path" constraints="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="CO_NAME" desc=""/>
    <constraint exp="" field="CO_ABBR" desc=""/>
    <constraint exp="" field="ACRES" desc=""/>
    <constraint exp="" field="Shape_Leng" desc=""/>
    <constraint exp="" field="Shape_Area" desc=""/>
    <constraint exp="" field="RO" desc=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" name="CO_NAME" hidden="0" width="-1"/>
      <column type="field" name="CO_ABBR" hidden="0" width="-1"/>
      <column type="field" name="ACRES" hidden="0" width="-1"/>
      <column type="field" name="Shape_Leng" hidden="0" width="-1"/>
      <column type="field" name="Shape_Area" hidden="0" width="-1"/>
      <column type="field" name="RO" hidden="0" width="-1"/>
